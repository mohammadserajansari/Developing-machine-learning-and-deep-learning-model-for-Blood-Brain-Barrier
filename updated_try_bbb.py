...
#     st.markdown("_This website belongs to Neurocare-eLAB and was developed by [Mohammad Seraj](https://www.linkedin.com/in/ansariserajmd/) (M.Tech, CB, IIIT-D) under the supervision of [Dr. N. Arul Murugan](https://www.iiitd.ac.in/arulmurugan)._")
...
# Streamlit App
def main():
    # Add CSS for background image and font color
    st.markdown(
        """
        <style>
        .reportview-container {
            background: url("https://timbilding.eu/wp-content/uploads/2019/12/%D1%81%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B5%D0%BD%D0%BA%D0%BE%D1%83%D1%87%D0%B8%D0%BD%D0%B3.jpg") no-repeat center center fixed; 
    ...
    # User input for SMILES
    smiles_input = st.text_input("Enter the SMILES :", key='smiles_input')
